...
<head>
    ...
    <style>
        :root {
            ...
            --container-width: <?= htmlspecialchars(get_theme_option('container_width', '960')); ?>px;
        ...
        /* Mobilní hodnoty (přebijí desktopové na menších obrazovkách) */
    ...
    <?php do_action('theme_head'); // DŮLEŽITÝ HÁČEK PRO PLUGINY ?>
</head>
<body>
    <header>
        <?php
            // Dynamické načtení URL adresy (slug) pro domovskou stránku
...
<?php foreach($menu_items as $item): ?>
    <?php 
        ...
        // Pokud nemáš target nastavený, použij _self jako default
